...
export const HeroCarousel: React.FC<HeroCarouselProps> = ({ products, featuredCollection }) => {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
            <div className="relative w-full h-[320px] md:h-[400px] rounded-2xl md:rounded-3xl overflow-hidden group shadow-sm border border-gray-100 dark:border-gray-800">
                {/* Slides */}
                <div
                                ...
                                <div className="max-w-lg flex flex-col h-full justify-center py-12 md:py-16">
                                    ...
                                    <div className="flex-grow flex flex-col justify-center space-y-4">
                                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/80 dark:bg-black/40 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 shadow-sm w-fit">
                                            ...
                                            <span className="text-[10px] md:text-xs font-bold text-gray-800 dark:text-gray-200 uppercase tracking-widest">
                                                {slide.subtitle}
                                            </span>
                                        </div>

                                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white tracking-tight leading-[1.1] line-clamp-2">
                                            {slide.title}
                                        </h2>
                                    ...
                                    <div className="pt-4 mt-auto md:mt-0">
                                        <Link
                                            href={slide.link}
                                            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-black text-sm font-bold rounded-full transition-all hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
                                        >
                                            Shop Collection
                ...
                <div className="hidden md:block">
                    <button
                        onClick={prevSlide}
                        className="absolute left-6 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/50 dark:border-white/10 text-gray-900 dark:text-white flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 hover:bg-white/60 dark:hover:bg-black/60 hover:scale-110 active:scale-95 z-20"
